...
public sealed partial class VoiceMaskNameChangeWindow : FancyWindow
{
    ...
    public Action<string>? OnVoiceChange; // Stories-TTS

    private List<(string, string)> _verbs = new();
    private List<TTSVoicePrototype> _voices = new(); // Stories-TTS
    ...
    public VoiceMaskNameChangeWindow()
    {
		...
		ReloadVoices(proto); // Stories-TTS
    ...
    public void UpdateState(string name, string voice, string? verb) // Stories-TTS
    {
