...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        public const float TtsMultiplier = 3f; // Stories-TTS
        ...
        public AudioTab()
        {
            ...
            TtsVolumeSlider.OnValueChanged += OnTtsVolumeSliderChanged; // Stories-TTS
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(SCCVars.TTSVolume, TtsVolumeSlider.Value / 100f * TtsMultiplier); // Stories-TTS
        ...
        private void Reset()
        {
            ...
            TtsVolumeSlider.Value = _cfg.GetCVar(SCCVars.TTSVolume) * 100f / TtsMultiplier; // Stories-TTS
        ...
        private void UpdateChanges()
        {
            ...
            var isTtsVolumeSame =
                Math.Abs(TtsVolumeSlider.Value - _cfg.GetCVar(SCCVars.TTSVolume) * 100f / TtsMultiplier) < 0.01f;
            ...
            isEverythingSame = isEverythingSame && isTtsVolumeSame; // Stories-TTS
            ...
            TtsVolumeLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", TtsVolumeSlider.Value / 100)); // Stories-TTS
