...
command-description-figurine-openslots = Открывает бесконечные слоты для всех заданий на всех прототипах карт, пока не будет перезапущен весь сервер.
command-description-hive-alldefault = Устанавливает улей ксеноса или группы ксеносов.
command-description-marine-randomize = Удаляет, а затем порождает морского пехотинца или группу морских пехотинцев в том же месте с рандомизированным именем, видом и внешностью.
...
command-description-xenomature = Мгновенно делает ксеноса взрослым. Применяется к королеве, после чего она получает больше здоровья и способностей.
